...
# theta_0 linearly spaced from -30 to +30 deg; all other ICs zero (stagnant)
theta0_values = np.linspace(np.radians(-25), np.radians(25), n_runs)

os.makedirs("results", exist_ok=True)

# --- Storage across runs ---
all_states = []   # list of (4, N) arrays
all_forces = []   # list of (N,) arrays
t_arr      = None
...
if args.animate:
    ...
    print("Animating first run (theta0 = -30 deg)...")
